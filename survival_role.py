...
print(color.DARKCYAN+"Welcome to the Bear Grylls Ultimate Survival Skills game.\nHere you will have to pass a series of levels that will challenge your abilities of surviving in the wild with very few resources.\nGood luck!")
print("Please select 3 of the following items to put in your backpack:"+color.END)
...
while ready_to_start == False:
    if len(backpack) == 3:
        print(color.DARKCYAN+'Good! You are ready to begin the adventure! This are the items in your backpack to begin with:')
        for i in backpack:
            print(i)
        ready_to_start = 1
    else:
...
print(color.BACKGROUNDBLUE+color.BLACK+"LEVEL1"+color.END+color.DARKCYAN)
